...
class _SingleCoursePageState extends State<SingleCoursePage>
  ...
  getData() async {
    ...
    print('Is Bundle Course: $isBundleCourse');  // Log if it's a bundle course or not
        ...
        child: Scaffold(
            appBar: AppBar(
              ...
              actions: [
                ...
                Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 8.0), // Optional padding between icons
                  child: IconButton(
                    icon: Icon(Icons.qr_code_scanner, color: Colors.black), // Scanner icon with black color
                    onPressed: () {
                      if (token.isEmpty) {
                        nextRoute(LoginPage.pageName);
                        showSnackBar(ErrorEnum.alert, appText.loginDesc);
